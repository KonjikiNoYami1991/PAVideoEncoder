...
namespace PA_Video_Encoder
{
    public partial class Seleziona_formati : Form
    {
        ...
        {
            if (clb_estensioni.CheckedItems.Count > 0)
                salva();
            else
            {
                MessageBox.Show("Selezionare almeno uno dei formati elencati", this.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
        }
